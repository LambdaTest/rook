...
Open **http://127.0.0.1:4310**, or the address printed in the terminal. Keep the app running. For help with keys or startup, see [runtime setup](runtime-setup.md).
...
```bash
npm run setup -- banking-agent-code
