# Northstar Bank — QE runtime setup
...
Open **http://127.0.0.1:4311**, or the address printed in the terminal. Keep it running. To check your key separately, use `npm run check:llm`; this makes a model request.
